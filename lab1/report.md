...
- при одинаковой частоте сигналов на прямоугольный приходится в 2 раза больше гармоник, следовательно, по теореме Парсеваля, энергия $E_\mathrm{p}$ прямоугольного сигнала в 2 раза больше энергии $E_\mathrm{t}$ треугольного:

  $\displaystyle E_x = \int\limits_{-\infty}^{+\infty} |\mathcal{F}\{x(t)\}|^2 \cdot d\omega\ \Longrightarrow\ E_\mathrm{p} \approx 2 E_\mathrm{t}$

</div>

- при известной ширине импульса для восстановления прямоугольного сигнала требуется одна точка: в начале или конце импульса; для восстановления треугольного сигнала требуются как минимум две точки.\
